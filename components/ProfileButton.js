          ...
          <div>
            <Menu as="div" className="text-left">
              <div>
                <Menu.Button>
                  <img
                    className="rounded-full h-8 w-8 cursor-pointer mt-1.5"
              ...
              >
                <Menu.Items className="absolute right-0 w-40 mt-2 origin-top-right bg-white/75 divide-y divide-gray-100 shadow-lg">
